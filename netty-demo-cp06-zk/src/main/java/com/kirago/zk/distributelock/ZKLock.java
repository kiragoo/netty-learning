...
//        ZKclient.instance.getClient();
        ...
        if(ZKclient.instance.isNodeExist(ZK_PATH)){
            ZKclient.instance.deleteNode(ZK_PATH);
        }
    ...
    public boolean lock(){
        synchronized (this){
            if(lockCount.get() ==0){
                ...
                log.info("进入到 lock 方法内..........");

                lockCount.incrementAndGet();
                log.info("currentName: {}", thread.getName());
...
/*
    ...
    private boolean tryLock() throws Exception {
        ...
        log.info("排队的 waiters: {}", list2String(waiters));
        ...
        log.info("locked_short_path 值为 {}", locked_short_path);
