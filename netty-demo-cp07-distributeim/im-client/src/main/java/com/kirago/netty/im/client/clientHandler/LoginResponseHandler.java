...
public class LoginResponseHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg)
        ...
        //判断类型
        Proto3Msg.ProtoMsg.Message ppm = (Proto3Msg.ProtoMsg.Message) msg;
        ...
        //判断返回是否成功
        Proto3Msg.ProtoMsg.LoginResponse info = ppm.getLoginResponse();
        ...
        if (!result.equals(ProtoInstant.ResultCodeEnum.SUCCESS)) {
            ...
            session.setSessionId(ppm.getSessionId());
            session.setLogin(true);

            log.info("step3：登录Netty 服务节点成功");
            eventController.notifyCommandThread();
